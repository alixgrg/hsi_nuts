...
from src.decision.labels import DEFAULT_TARGET_CLASS, DEFAULT_NON_TARGET_LABEL
...
def compare_pca_representations(
    ...
    allowed_labels=(DEFAULT_TARGET_CLASS, DEFAULT_NON_TARGET_LABEL),
    n_components=5,
    m=40,
    wavelengths=None,
    random_state=42,
    ...
    for matrix_method in matrix_methods:
        ...
        for preproc_name, steps in preprocessing_configs.items():
            ...
            row = {
                ...
                f"n_{DEFAULT_TARGET_CLASS}": label_count_dict.get(DEFAULT_TARGET_CLASS, 0),
                f"n_{DEFAULT_NON_TARGET_LABEL}": label_count_dict.get(DEFAULT_NON_TARGET_LABEL, 0),
